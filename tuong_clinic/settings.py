# Django settings for tuong_clinic project.
import os
import sys
...
SECRET_KEY = '+rt9_(w@bdg_q0=2y_oxhu$=$uvv8p8+kg46l^&+r-n@-7%*k0'
...
ROOT_URLCONF = 'tuong_clinic.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tuong_clinic.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('tuong_clinic.migrations', 'tuong_clinic.tests',
                            'tuong_clinic.local_settings',
...
DEFAULT_DOMAIN = 'http://tuong_clinic.com/'
